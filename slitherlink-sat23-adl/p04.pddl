;; ../../../domain-slitherlink/generator-solver/generate-pddl.py gen 5 6 p04.pddl p04.plan
;;
;;  3.1..2
;;  ..2...
;;  221...
...
(define (problem sliterlink-739363)
(:domain slitherlink)

(:objects
    cap-0 cap-1 cap-2 cap-3 cap-4 - cell-capacity-level
    n-0-0 n-0-1 n-0-2 n-0-3 n-0-4 n-0-5 n-0-6 n-1-0 n-1-1 n-1-2 n-1-3 n-1-4 n-1-5 n-1-6 n-2-0 n-2-1 n-2-2 n-2-3 n-2-4 n-2-5 n-2-6 n-3-0 n-3-1 n-3-2 n-3-3 n-3-4 n-3-5 n-3-6 n-4-0 n-4-1 n-4-2 n-4-3 n-4-4 n-4-5 n-4-6 n-5-0 n-5-1 n-5-2 n-5-3 n-5-4 n-5-5 n-5-6 - node
    cell-0-0 cell-0-1 cell-0-2 cell-0-3 cell-0-4 cell-0-5 cell-1-0 cell-1-1 cell-1-2 cell-1-3 cell-1-4 cell-1-5 cell-2-0 cell-2-1 cell-2-2 cell-2-3 cell-2-4 cell-2-5 cell-3-0 cell-3-1 cell-3-2 cell-3-3 cell-3-4 cell-3-5 cell-4-0 cell-4-1 cell-4-2 cell-4-3 cell-4-4 cell-4-5 cell-outside-0-left cell-outside-0-right cell-outside-1-left cell-outside-1-right cell-outside-2-left cell-outside-2-right cell-outside-3-left cell-outside-3-right cell-outside-4-left cell-outside-4-right cell-outside-0-up cell-outside-0-down cell-outside-1-up cell-outside-1-down cell-outside-2-up cell-outside-2-down cell-outside-3-up cell-outside-3-down cell-outside-4-up cell-outside-4-down cell-outside-5-up cell-outside-5-down - cell
)
