;; ../../../domain-slitherlink/generator-solver/generate-pddl.py gen 4 8 p05.pddl p05.plan
;;
;;  ..3.2.3.
;;  2.32...2
;;  2....23.
...
(define (problem sliterlink-874875)
(:domain slitherlink)

(:objects
    cap-0 cap-1 cap-2 cap-3 cap-4 - cell-capacity-level
    n-0-0 n-0-1 n-0-2 n-0-3 n-0-4 n-0-5 n-0-6 n-0-7 n-0-8 n-1-0 n-1-1 n-1-2 n-1-3 n-1-4 n-1-5 n-1-6 n-1-7 n-1-8 n-2-0 n-2-1 n-2-2 n-2-3 n-2-4 n-2-5 n-2-6 n-2-7 n-2-8 n-3-0 n-3-1 n-3-2 n-3-3 n-3-4 n-3-5 n-3-6 n-3-7 n-3-8 n-4-0 n-4-1 n-4-2 n-4-3 n-4-4 n-4-5 n-4-6 n-4-7 n-4-8 - node
