;; ../../../domain-slitherlink/generator-solver/generate-pddl.py gen 7 11 p15.pddl p15.plan
;;
;;  3.3....3...
;;  .3..02222.3
;;  2.2..2.2...
...
(define (problem sliterlink-658699)
(:domain slitherlink)

(:objects
    cap-0 cap-1 cap-2 cap-3 cap-4 - cell-capacity-level
    n-0-0 n-0-1 n-0-2 n-0-3 n-0-4 n-0-5 n-0-6 n-0-7 n-0-8 n-0-9 n-0-10 n-0-11 n-1-0 n-1-1 n-1-2 n-1-3 n-1-4 n-1-5 n-1-6 n-1-7 n-1-8 n-1-9 n-1-10 n-1-11 n-2-0 n-2-1 n-2-2 n-2-3 n-2-4 n-2-5 n-2-6 n-2-7 n-2-8 n-2-9 n-2-10 n-2-11 n-3-0 n-3-1 n-3-2 n-3-3 n-3-4 n-3-5 n-3-6 n-3-7 n-3-8 n-3-9 n-3-10 n-3-11 n-4-0 n-4-1 n-4-2 n-4-3 n-4-4 n-4-5 n-4-6 n-4-7 n-4-8 n-4-9 n-4-10 n-4-11 n-5-0 n-5-1 n-5-2 n-5-3 n-5-4 n-5-5 n-5-6 n-5-7 n-5-8 n-5-9 n-5-10 n-5-11 n-6-0 n-6-1 n-6-2 n-6-3 n-6-4 n-6-5 n-6-6 n-6-7 n-6-8 n-6-9 n-6-10 n-6-11 n-7-0 n-7-1 n-7-2 n-7-3 n-7-4 n-7-5 n-7-6 n-7-7 n-7-8 n-7-9 n-7-10 n-7-11 - node
